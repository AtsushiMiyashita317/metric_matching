...
from metric_matching.atlas_module import (
    AtlasMetricConfig,
    AtlasMetricModule,
)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Train an atlas denoiser with image-space white noise on 3dshapes."
    )
    ...
    parser.add_argument("--pretrained-denoiser-checkpoint", type=str, default=None)
    ...
    parser.add_argument("--epsilon-min", type=float, default=1e-0)
    ...
    parser.add_argument("--run-name", type=str, default="3dshapes-atlas-denoiser")
...
def main() -> None:
    ...
    config = AtlasMetricConfig(
        ...
        denoiser_training_mode=args.denoiser_training_mode,
        pretrained_denoiser_checkpoint=args.pretrained_denoiser_checkpoint,
    ...
    callbacks = [
        ModelCheckpoint(
            ...
            mode="min",
            save_top_k=1,
            filename="atlas-denoiser-{epoch:02d}",
        ),
    ]
